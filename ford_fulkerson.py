...
class FordFulkerson:
    ...
    def ford_fulkerson(self, graph, source, sink):
        # Initialize the flow network with 0 flow on each edge to create the residual graph
    ...
    def find_augmenting_path(self, graph, flow, source, sink): # using a BFS search
